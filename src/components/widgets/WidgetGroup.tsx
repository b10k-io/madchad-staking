...
import { formatBalance, formatCommify, formatPercentage } from "../../support/formatters"
    ...
    return (
        <Container>
            <div className={`grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8`}>
                ...
                <BasicWidget heading={`${formatCommify(depositedETH)} BNB`} subheading="Rewards Deposited" isLoading={isLoadingDepositedETH} />
