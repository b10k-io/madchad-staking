    ...
    return (
        <DialogWrapper isOpen={isOpen} openModal={openModal} closeModal={closeModal}>
            <div className='flex flex-col gap-8'>
                ...
                <div>
                    <div className='p-3 text-sm bg-amber-100 rounded border-0 border-amber-300 text-amber-900'>One or more of your deposits were deposited less than 20 days ago and are therefore subject to a 20% early withdrawl fee.</div>
                </div>
